...
layui.define('jquery', function(exports){
  ...
  Element.prototype.tabDelete = function(filter, layid){
    ...
    call.tabDelete(null, liElem,layid);
    return this;
  };
  ...
  ,call = {
    ...
    ,tabDelete: function(e, othis,layid){
      ...
      li.remove();
     // console.info('+++++++++' + deleteContent.find('webview')[0].id)
